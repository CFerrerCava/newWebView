    ...
    Object.entries(dataGroup).forEach((value, index_row) => {
        ...
        value[1].forEach((value, index_column) => {
            if (value.tipoAsiento === 'ES') {
                lader.querySelector("td").id = "row_" + index_row + "_lader_" + index_column;
                // clone a lader
            ...
            if (value.tipoAsiento === 'PJ') {
                var isBussy =  bussies.filter((_value) => _value === value.asiento).length > 0             
                var td =  sit.querySelector("td")
                td.querySelector("label").textContent =value.asiento
                    
                td.id = "row_" + index_row + "_sit_" + index_column;
           
                td.className = isBussy ? 'flat__bus--sit chair-img bussy-pj ':' flat__bus--sit chair-img'
                // clone a sit
            ...
            if (value.tipoAsiento === 'TV') {
                ...
                tv.querySelector("td").id = "row_" + index_row + "_sit_" + index_column;
                // clone a tv
            ...
            if (value.tipoAsiento === 'PA') {
                ...
                pass.querySelector("td").id = "row_" + index_row + "_sit_" + index_column;
                // clone a pass
